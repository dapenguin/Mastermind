 ...
 * @param  {Object} colourTotals The number of each colour used in the code.
 ...
 */
function getGuessResult (codeGuess, numberOfPegs, secretCode, colourTotals, triesLeft) {
	let winner = false;
	let gameOver = false;
	...
	if (guessResult.totalExactMatches === numberOfPegs) {
		...
		guessResult = getPartialMatches(guessResult, codeGuess, numberOfPegs, secretCode, colourTotals);
